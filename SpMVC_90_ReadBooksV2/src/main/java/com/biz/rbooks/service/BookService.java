...
/*
 * private final로 설정된 필드변수들의 생성자를 생성하고 자동 inject(@Autowired)를 수행 해준다
 * 그래서, 생성자를 따로 만들어주지 않아도 됨
 */
...
public class BookService {
	...
	public List<BookVO> findByBNames(String strText) {
		...
		// strText를 빈칸으로 분해해서 문자열 배열을 만들고 그 배열을 List<String>형으로 변환한 다음 names List에 담아라
