...
public class ToDoController {
	...
	public String list(Model model) {
		/*
		 * 팀프로젝트에서 Controller 개발자와, Service 개발자가 다를경우 Service는 interface가 정의되어 있기 때문에
		 * 아직 기능은 구현되지 않았어도 Controller 개발자는 당연히 Service의 method를 호출하면 결과가 리턴될 것이다라는 것을 알고
		 * 나머지 코드를 구현할 수 있게 된다.
		 */
	...
	public String insert(@ToDoAnn @ModelAttribute ToDoList toDoList, Model model) {
	...
	public String update(ToDoList toDoList, Model model) {
		
		toService.update(toDoList);	
