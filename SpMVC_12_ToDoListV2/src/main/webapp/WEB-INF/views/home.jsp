		...
		<article id="input">
			<form method="POST">
				...
				<table class="input">
					<tr>
						<td>
							<label id="tdFlag">중요도</label>
							<input type="number" min="1" max="5" name="tdFlag" id="td_flag" value="<c:out value='${todoDTO.td_flag}' default='1'/>">
						</td>
						...
						<td>
							<input type="checkbox" name="td_alarm" 
							<c:if test="${todoDTO.td_alarm == 'Y'}"> checked='checked'</c:if> value="Y">
							<label for="tdAlarm">알람 설정</label>
						</td>
