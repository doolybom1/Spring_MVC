...
public class ReadBookController {
	...
	public String list(Model model) {
		...
		List<ReadBookVO> readBookList = readBookService.selectAll();
		
		model.addAttribute("RBOOKS",readBookList);
	...
	public String insert(ReadBookVO readBookVO) {
	...
	public String view(@PathVariable("rb_seq")long rb_seq, Model model) {
		...
		ReadBookVO rBookVO = readBookService.findBySeq(rb_seq);
		
		model.addAttribute("RBOOK",rBookVO);
		
		String b_code = rBookVO.getRb_bcode();
		
		BookVO bookVO = bookService.findByBCode(b_code);
		
		model.addAttribute("BOOK",bookVO);
		
		List<ReadBookVO> readBookList = readBookService.findByBCode(b_code);
...
//		
	...
	public String update(ReadBookVO readBookVO, Model model) {
